...
- [ ] Tous les champs qui contiennent des mots de passe ne sont pas visible à l'écran (mais des *** à la place), mais avec possibilité des les révéler (bouton "œil")
- [ ] Quand les mots de passes ne correspondent pas, un message d'erreur clair apparaît
